    ...
    .factory('$position', function ($document, $window) {
        ...
        return {
            ...
            offset: function (element, container) {
                ...
                if (container) {
                    containerOffset = this.offset(container);
                }

                return {
                    width: boundingClientRect.width || element.prop('offsetWidth'),
                    height: boundingClientRect.height || element.prop('offsetHeight'),
                    top: boundingClientRect.top + ($window.pageYOffset || $document[0].documentElement.scrollTop) - containerOffset.top,
                    left: boundingClientRect.left + ($window.pageXOffset || $document[0].documentElement.scrollLeft) - containerOffset.left
                };
            },
    ...
    .directive('fillHeight', function (ggFillHeight, $window, $rootScope, $timeout) {
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                function fillHeight () {
                    ggFillHeight(property, element, offset);
                }
